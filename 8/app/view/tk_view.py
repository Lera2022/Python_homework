...
def init_main_table():
    ...
    main_table = ttk.Treeview(main_window, show='headings', columns=[
                              'Наименование', 'Телефон'], name='table_main')
...
def init_control_panel():
    ...
    btn_remove = ttk.Button(top_panel, text='Удалить',
                            command=btn_remove_click)
